        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 about-images" data-aos="fade-up" data-aos-delay="200">
                    <div class="row gy-4">
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/img/about-us/about-1.jpg') }}" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="row gy-4">
                                <div class="col-lg-12">
                                    <img src="{{ asset('assets/img/about-us/about-2.jpg') }}" class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-12">
                                    <img src="{{ asset('assets/img/about-us/about-3.jpg') }}" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-around gy-4">
                ...
                <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>
                        کیفیت محصولات ما حاصل بهره‌گیری از پیشرفته‌ترین دستگاه‌های تولید و آزمایشگاه‌های مجهز است که
                        تضمین می‌کند هر جوهر و مدیای چاپی که به دست شما می‌رسد، بالاترین استانداردهای جهانی را دارا
                        باشد. این کیفیت بالا نه تنها موجب افزایش دقت و زنده‌بودن رنگ‌ها در چاپ می‌شود، بلکه دوام بیشتری
                        نیز برای چاپ‌های شما به ارمغان می‌آورد.
                    </p>

                    <p>
                        ما همچنین با پشتیبانی مستمر در کنار شما هستیم تا در هر مرحله‌ای از چاپ، از انتخاب محصول گرفته تا
                        تنظیمات فنی دستگاه‌ها، بتوانید به بهترین نتایج دست پیدا کنید. تیم پشتیبانی ما به صورت ۲۴/۷ آماده
