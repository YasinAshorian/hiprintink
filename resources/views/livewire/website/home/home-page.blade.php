            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">ADVERTISEMENT <br>ECO-SOLVENT INK </a></h3>
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">REACTIVE DAY INK</a></h3>
                        </div>
                    </div>
                </div><!-- End Property Item -->
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">NED UV INK</a></h3>
                        </div>
                    </div>
                </div><!-- End Property Item -->
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">TEXTILE PIGMENT INK <br> (DIRECT TO GARMENTS) </a>
                            </h3>
                        </div>
                    </div>
                </div><!-- End Property Item -->
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">SUBLIMATION INK </a></h3>
                        </div>
                    </div>
                </div><!-- End Property Item -->
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3><a href="#" class="stretched-link">SOLVENT INK <br> DESCRIPTION </a></h3>
                        </div>
                    </div>
                </div><!-- End Property Item -->
