<div>
    ...
    <!-- products -->
    <section id="services" class="services section custom-bg py-5">
                            ...
                            <div class="card h-100 minimal-card">
                                ...
                                <div class="card-body p-3">
                                    <div class="text-center">
                                        ...
                                        <div class="mt-3">
                                            <p class="mb-0 fw-bold fs-5" style="color:#d92332;"><?php echo e(number_format($item->price)); ?> <span class="small fw-normal">تومان</span></p>
                                        </div>
